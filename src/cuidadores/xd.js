...
export default function DoubleSliderForm() {
  ...
  // Animación de entrada para resaltar el contenido al cargar la página
  const [animateEntry, setAnimateEntry] = useState(false);
  useEffect(() => {
    setAnimateEntry(true);
    // Opcional: quitar la animación después de 1s para permitir re-animar si se desea
  ...
  return (
    <>
      {/* Menú de hamburguesa en la parte superior izquierda, sin fondo en el botón pero con fondo en el menú y menos espaciado */}
        ...
        <div className="form-container sign-in-container" style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
          ...
          >
            ...
            <div className="text-center text-sm text-gray-600 mt-6">
              <p className="mb-2 hover:underline cursor-pointer transition-colors duration-200 hover:text-[#9BDCFD]">
